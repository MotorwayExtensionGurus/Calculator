...
namespace MEGCalc
{
    public partial class Form1 : Form
    {
        ...
        private double netherrackPerDay;
            ...
            try // Couldn't be bothered to check if the input is a number or text, so i just added a try catch
            {
                ...
                if (player2 != 0 && player2 > 0 && player1 > 0) // Starts the calculating process if both fields has an input
                {
                    ...
                    if (totalDistance > 0 && totalDistance < 3750000) // Checks if the distance is valid
                    {
                        ...
                        Netherrack.Text =
                            string.Format("{0:n0}", double.Parse(Netherrack.Text)); //I tried to split up the 1000's like 1,000,000 instead of 1000000 but
                        Distance.Text = string.Format("{0:n0}",
                            double.Parse(Distance.Text)); // i just couldn't get it to work for the life of me. It still outputs the number here though
                    }
                    else
                    {
                        Distance.Text = "";
            ...
            try // Couldn't be bothered to check if the input is a number or text, so i just added a try catch
            {
                ...
                ) // Starts the calculating process if all fields has an input
                {
                    ...
                    if (oldtotalDistance > 0 && oldtotalDistance < 3750000) // Checks if the distance is valid
                    {
                        ...
                        if (DistancePerDay < 0)
                            DistancePerDay = DistancePerDay * -1;
                        ...
                        if (netherrackPerDay < 0)
                            netherrackPerDay = netherrackPerDay * -1;
